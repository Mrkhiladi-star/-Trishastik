...
const Auth = () => {
  ...
  const [forgotOtpRequired, setForgotOtpRequired] = useState(false);
  ...
  const handleResendOtp = async () => {
    ...
    try {
      ...
      setSignupError("Failed to resend code due to a network error.");
    } finally {
                    ...
                    <form onSubmit={handleForgotSubmit} className="space-y-4">
                      <div className="space-y-1.5">
                        ...
                        <input
                          ...
                          className="w-full glass-input rounded-xl px-4 py-3 text-sm focus:outline-none"
                          placeholder="enter_registered_email@example.com"
                          required
                        />
                      </div>
